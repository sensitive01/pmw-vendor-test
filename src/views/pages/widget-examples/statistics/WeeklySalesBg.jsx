...
const Sales = () => {
  const [data, setData] = useState([
    { stats: '0', color: 'success', title: 'Booked Slots', icon: 'ri-database-2-line' },
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        setData([
          { stats: totalCount, color: 'success', title: 'Booked Slots', icon: 'ri-database-2-line' },
      ...
      <CardHeader
        ...
        subheader={
          <div className='flex items-center gap-2'>
            <span>Total {data[0].stats} Slots Booked</span>
          </div>
        }
      />
      <CardContent>
